...
#   points = nil
#   game_hash.each do |key, team_name|
#     if team_name[:players].has_key?(player_name)
#       points = team_name[:players][player_name][:player_stats][:points]
#     end
#   end
#   points
# end
...
#   game_hash.each do |key, team_name|
#     if team_name[:players].has_key?(player_name)
#       shoe_size = team_name[:players][player_name][:shoe_size]
#     end
#   end
#   shoe_size
# end
...
def big_shoe_rebounds
  ...
  elsif big_shoe_player_info[1][:shoe] > big_shoe_player_info[0][:shoe]
